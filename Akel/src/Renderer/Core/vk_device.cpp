...
namespace Ak
{
	...
	void Device::init()
	{
		...
		Core::log::report(DEBUGLOG, "Vulkan : created logical device");
	}
	...
	void Device::pickPhysicalDevice()
	{
		...
		SDL_Window* window = SDL_CreateWindow("pouic", 0, 0, 1, 1, SDL_WINDOW_VULKAN | SDL_WINDOW_HIDDEN);
		if(!window)
		...
		Core::log::report(DEBUGLOG, "Vulkan : picked a physical device, %s", props.deviceName);
	#endif
	}
