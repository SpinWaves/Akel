...
namespace Ak
{
	class IBO : public Buffer
	{
		public:
			...
			inline void bind() noexcept { vkCmdBindIndexBuffer(Render_Core::get().getActiveCmdBuffer().get(), _buffer, static_cast<VkDeviceSize>(_mem_chunck.offset), VK_INDEX_TYPE_UINT32); }
	};
