...
#define __AK_PROFILE_CORE__
	...
	#define AK_MIPS
#elif defined(__sh__)
	#define AK_arch "superh"
	#define AK_SUPERH
#elif defined(__powerpc) || defined(__powerpc__) || defined(__powerpc64__) || defined(__POWERPC__) || defined(__ppc__) || defined(__PPC__) || defined(_ARCH_PPC)
	#define AK_arch "powerpc"
	#define AK_POWERPC
#elif defined(__PPC64__) || defined(__ppc64__) || defined(_ARCH_PPC64)
	#define AK_arch "powerpc"
	#define AK_POWERPC64
#elif defined(__sparc__) || defined(__sparc)
	#define AK_arch "sparc"
	#define AK_SPARC
#elif defined(__m68k__) // if you want to try you cannot run akel on a m68k lol
	#define AK_arch "cisc"
	#define AK_M68K
#else
	#define AK_arch "unknown"
#endif
