...
add_requires("libsdl_image", "libsdl", "libsdl_ttf", "libsndfile", "openal-soft", "shaderc", "vulkan-headers", "volk", "vulkan-loader", "vulkan-validationlayers", "imgui_sdl_vk v1.87-docking")
...
target("Akel")
	...
	add_packages("libsdl_image", "libsdl", "libsdl_ttf", "libsndfile", "openal-soft", "shaderc", "vulkan-headers", "volk", "vulkan-loader", "vulkan-validationlayers", "imgui_sdl_vk")
